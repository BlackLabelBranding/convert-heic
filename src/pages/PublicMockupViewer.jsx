  ...
  useEffect(() => {
    async function loadPublicProject() {
      ...
      if (projectError || !projectData) {
        setErrorMessage("This shared magazine was not found or is not public.");
        setLoading(false);
        return;
      }
      ...
      if (pageError) {
        setErrorMessage(pageError.message || "Failed to load pages.");
        setLoading(false);
        return;
      }
    ...
    return (
      <div style={styles.page}>
        <div style={styles.centerWrap}>
          <div style={styles.notFoundCard}>Loading shared magazine...</div>
        </div>
      </div>
    );
  }
      ...
      <div style={styles.page}>
        <div style={styles.centerWrap}>
          <div style={styles.notFoundCard}>
            <h1 style={styles.notFoundTitle}>Shared magazine not found</h1>
            <p style={styles.notFoundText}>{errorMessage || "This link is invalid."}</p>
          </div>
        </div>
      </div>
    );
  ...
  return (
    <div style={styles.page}>
      <div style={styles.topBar}>
        <div>
          <div style={styles.brand}>Black Label Shared Preview</div>
